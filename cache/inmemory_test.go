...
var newInMemoryStore = func(_ *testing.T, defaultExpiration time.Duration, cleanupInterval time.Duration) Store {
	return NewInMemoryStore(defaultExpiration, cleanupInterval)
}
