...
func NewInMemoryStore(defaultExpiration time.Duration, cleanupInterval time.Duration) *InMemoryStore {
	return &InMemoryStore{*cache.New(defaultExpiration, cleanupInterval)}
}
